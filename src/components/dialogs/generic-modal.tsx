  ...
  return (
    ...
    >
      <DialogContent
        ...
        className={cn(
          'flex max-h-[95vh] flex-col overflow-hidden border-0 bg-white p-0 shadow-2xl',
      ...
      >
        <div className="absolute right-2 top-4 z-50 flex items-center gap-2">
          {showCustomAction && customActionHandler && (
            <button
              ...
              className={cn(
                ...
                'bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 shadow-lg backdrop-blur-sm',
          ...
          >
            <X
              className={cn(
                'h-8 w-8 text-gray-600 transition-all duration-300',
                'group-hover:rotate-90 group-hover:text-gray-900'
              )}
            />
          </button>
        </div>
